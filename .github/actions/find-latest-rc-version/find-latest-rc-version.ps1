...
.EXAMPLE
    .\find-latest-rc-version.ps1 -GitHubToken $token -Repository "optivem/myrepo"
    .\find-latest-rc-version.ps1 -RcVersion "1.0.5-rc.47" -GitHubToken $token -Repository "optivem/myrepo"
#>
